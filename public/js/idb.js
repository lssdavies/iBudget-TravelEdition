...
request.onupgradeneeded = function (event) {
  ...
  // create an object store (document) called `new_transaction`, set it to have an auto incrementing primary key of sorts
...
// listen for app coming back online. once connection is restored this even listener will run the uploadPizaa() to upload any pizza created offline.
